...
namespace PC2.Data.Migrations
{
    ...
    [Migration("20250927021807_VisitasReservasValidaciones")]
    partial class VisitasReservasValidaciones
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PC2.Models.Inmueble", b =>
                {
                    ...
                    b.ToTable("Inmuebles", t =>
                        {
                            t.HasCheckConstraint("CK_Inmueble_MetrosCuadrados_Positive", "[MetrosCuadrados] > 0");
